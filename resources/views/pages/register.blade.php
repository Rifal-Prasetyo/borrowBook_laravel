...
<div class="w-screen h-screen flex justify-center items-center">
    ...
    <div class="w-[90%] md:w-[40%] lg:w-[30%] bg-slate-50 px-8 py-8 rounded-2xl">
        <h1 class="font-bold text-lg md:text-2xl w-full  text-slate-700">Buat akunmu sendiri</h1>
        <h2 class="font-light text-sm md:text-lg text-slate-600 mb-4">akun yang kamu digunakan untuk melakukan layanan
            sistem ini
        </h2>
        ...
        <form action="{{ route('loginAction') }}" method="post" class="w-full ">
            ...
            <input type="email" name="email" id="email"
                class="w-full px-4 py-2 rounded mb-2 border border-black" placeholder="Masukkan Email">
